        ...
        <div className="-my-2 overflow-x-auto">
          <div className="inline-block min-w-full align-middle">
            <div className="overflow-hidden shadow ring-1 ring-black ring-opacity-5">
              <table className="fs-13 text-grey300 min-w-full divide-y divide-gray-300 font-medium">
                ...
                <tbody className="divide-y divide-gray-200 bg-white">
                  <tr className="divide-gray-200 xl:divide-x">
                    <td className="fs-13 text-grey300 min-w-[293px] whitespace-nowrap py-3 pl-3 pr-3 align-top font-medium">
                    ...
                    <td className="fs-13 text-grey300 hidden min-w-[125px] whitespace-nowrap border-r-0 border-none py-3 pl-3 pr-3 text-right lg:table-cell">
                      <div className="mb-1.5">06.01.2022 </div>
                      <div className="text-757575 text-xs">4:00PM</div>
                    </td>

                    <td className="fs-13 text-grey300 hidden min-w-[140px] whitespace-nowrap border-r-0 border-none py-3 pl-3 pr-3 text-right align-top md:table-cell">
                    ...
                    <td className="fs-13 text-grey300 hidden min-w-[255px] whitespace-nowrap py-3 pl-3 pr-3 sm:table-cell">

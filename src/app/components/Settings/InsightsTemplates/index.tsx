...
const InsightsTemplates = () => {
  return (
    <div id="insightsTemplates_content" className="tabcontent mt-10">
      <div className="mb-5 flex items-center justify-between">
        <h1 className="font-gilroyBold text-424242 m-0 text-xl leading-5">Insights Templates</h1>
      </div>
                ...
                <table className="fs-13 text-616161 min-w-full divide-y divide-gray-300 font-medium">
                  ...
                  <tbody className="divide-y divide-gray-200 bg-white">
                    <tr className="divide-gray-200 xl:divide-x">
                      ...
                      <td className="fs-13 text-616161 hidden min-w-[140px] whitespace-nowrap border-r-0 border-none py-3 pl-3 pr-3 text-right align-top md:table-cell">
